...
export class MessagesService {
    ...
    getAllNotificationList(): Observable<any> {
        return this.http.get(apiURL + '/notification/GetAllNotificationList').map(response => response.json());
    }
    disMissNotification(id: number): Observable<any> {
        return this.http.get(apiURL + '/notification/DisMissNotification?id=' + id).map(response => response.json());
    }
}