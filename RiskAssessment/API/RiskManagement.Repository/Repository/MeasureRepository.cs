...
{
    public class MeasureRepository : RepositoryBase<RiskManagement.Data.Measure>, IMeasureRepository, IDisposable
    {
        private RiskManagement.Data.UnitOfWork.UnitOfWork _unitOfWork = null;

        public MeasureRepository(RiskManagement.Data.UnitOfWork.UnitOfWork unitOfWork) : base(unitOfWork.Context)
        {
            this._unitOfWork = unitOfWork;
        }

        public void Add(RiskManagement.Data.Measure entity, int LoggedInUserId, int LoggedInOrganizationId)
        {
