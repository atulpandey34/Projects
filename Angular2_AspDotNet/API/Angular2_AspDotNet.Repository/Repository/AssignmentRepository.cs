...
{
    public class AssignmentRepository : RepositoryBase<Angular2_AspDotNet.Data.Assignment>, IAssignmentRepository, IDisposable
    {
        private Angular2_AspDotNet.Data.UnitOfWork.UnitOfWork _unitOfWork = null;
        private IUserRepository _IUserRepository = null;

        public AssignmentRepository(Angular2_AspDotNet.Data.UnitOfWork.UnitOfWork unitOfWork) : base(unitOfWork.Context)
        {
            this._unitOfWork = unitOfWork;
            this._IUserRepository = new UserRepository(unitOfWork);
        }
        public void Add(Angular2_AspDotNet.Data.Assignment entity, int LoggedInUserId, int LoggedInOrganizationId)
        {
