...
export const verticalMenuItems = [
    ...
    new Menu(201, 'Meeting', null, null, 'users', null, true, 0),
    new Menu(202, 'Meeting List', '/pages/meeting/list', null, 'users', null, false, 201),
    new Menu(203, 'New Meeting', '/pages/meeting', null, 'users', null, false, 201),
    new Menu(204, 'Action', null, null, 'users', null, true, 0),
    new Menu(205, 'Action List', '/pages/action/list', null, 'users', null, false, 204),
    new Menu(206, 'New Action', '/pages/action', null, 'users', null, false, 204),
    new Menu(207, 'User', null, null, 'users', null, true, 0),
    new Menu(208, 'User List', '/pages/user/list', null, 'users', null, false, 207),
    new Menu(209, 'New User', '/pages/user', null, 'users', null, false, 207),
    new Menu(210, 'Corrective Action', null, null, 'users', null, true, 0),
    new Menu(211, 'Corrective Action List', '/pages/correctiveaction/list', null, 'users', null, false, 210),
    new Menu(212, 'New Corrective Action', '/pages/correctiveaction', null, 'users', null, false, 210),

    new Menu(213, 'Risk Assessment', null, null, 'users', null, true, 0),
    new Menu(214, 'Risk Assessment List', '/pages/riskassessment/list', null, 'users', null, false, 213),
    new Menu(215, 'New Risk Assessment', '/pages/riskassessment', null, 'users', null, false, 213),

    new Menu(216, 'Assignment', null, null, 'users', null, true, 0),
    new Menu(217, 'Assignment List', '/pages/assignment/list', null, 'users', null, false, 216),
    new Menu(218, 'New Assignment', '/pages/assignment', null, 'users', null, false, 216),

    new Menu(219, 'Training', null, null, 'users', null, true, 0),
    new Menu(220, 'Training List', '/pages/training/list', null, 'users', null, false, 219),
    new Menu(221, 'New Training', '/pages/training', null, 'users', null, false, 219),
    new Menu(222, 'Trainer', '/pages/training/trainer', null, 'users', null, false, 219),
    new Menu(223, 'Trainee', '/pages/training/trainee', null, 'users', null, false, 219),
    new Menu(224, 'Training Report', '/pages/training/trainingreport', null, 'users', null, false, 219),
    new Menu(225, 'Trainee Report', '/pages/training/userreport', null, 'users', null, false, 219),
    new Menu(226, 'Trainer Report', '/pages/training/trainerreport', null, 'users', null, false, 219),

    new Menu(275, 'Document', null, null, 'users', null, true, 0),
    new Menu(276, 'Document List', '/pages/document/list', null, 'users', null, false, 275),
    new Menu(277, 'New Document', '/pages/document', null, 'users', null, false, 275),
    new Menu(278, 'Folder List', '/pages/folder/', null, 'users', null, false, 275),

    new Menu(279, 'Roles', null, null, 'users', null, true, 0),
    new Menu(280, 'Roles Responsibility', '/pages/rolesresponsibility', null, 'users', null, false, 279),

    new Menu(281, 'Performance Review Meeting', null, null, 'users', null, true, 0),
    new Menu(282, 'Performance Review Meeting List', '/pages/performancereviewmeeting/list', null, 'users', null, false, 281),
    new Menu(283, 'New Performance Review Meeting', '/pages/performancereviewmeeting', null, 'users', null, false, 281),

    new Menu(285, 'Measure', null, null, 'users', null, true, 0),
    new Menu(286, 'New Measure', '/pages/measure', null, 'users', null, false, 285),
    new Menu(287, 'Measure List', '/pages/measure/list', null, 'users', null, false, 285),
    new Menu(288, 'Measure Chart', '/pages/measure/chart', null, 'users', null, false, 285),

    new Menu(294, 'Menu', null, null, 'users', null, true, 0),
    new Menu(295, 'New Menu', '/pages/menu', null, 'users', null, false, 294),
    new Menu(296, 'Menu List', '/pages/menu/list', null, 'users', null, false, 294),
    new Menu(297, 'Assigned Role', '/pages/menu/role', null, 'users', null, false, 294),
...
export const verticalMenuItemsV1: Menu[] = [];