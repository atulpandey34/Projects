...
var AuditService = /** @class */ (function () {
    ...
    AuditService.prototype.getAuditSubjectListData = function (filter) {
        return this.http.post(apiURL + '/audit/GetAuditSubjectListData', filter).map(function (response) { return response.json(); });
    };
    ...
    //Audit Review Report
    AuditService.prototype.getAuditReport = function (id) {
        return this.http.get(apiURL + '/audit/GetAuditReport?Auditid=' + id).map(function (response) { return response.json(); });
    };
